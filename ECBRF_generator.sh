...
#SBATCH -N 1
#SBATCH -n 1
#SBATCH --partition=PV100q
#SBATCH -w node09
#SBATCH --gres=gpu:1
#SBATCH --output /export/home/zonglin001/Out/yelp_bart_comet_subset0_bs16_Seed106_gene.out
...
python -u ./comet-case-based-train-updating-retriever-twoEmbedder-DPR-faster-May-TST.py \
        --do_train --train_batch_size 8 --dev_batch_size 8 \
        --do_test --test_batch_size 8 \
        ...
        --output_dir /export/home/zonglin001/Checkpoints/yelp_bart_comet_subset0_bs16_Seed106/  \
        --seed 106 \
        --dataset_selection 6 --subset_selection 0 \
